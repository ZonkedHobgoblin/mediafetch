...
- [ ] [v1.0.7] **Logging**: Switching to logging over printing for error messages.
- [ ] [v1.0.8] **Internalization**: i18n to move all strings into seperate files, for better DRY and future localisation.
